...
const string strMessageMagic = "JXCoin Signed Message:\n";
    ...
    int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees, int nHeight)
{
    ...
    int nHeightCount = (nHeight / 8000000) * 2;

    // Per 8,000,000 cut down with half to reward;
    if (nHeight <= LAST_POW_BLOCK && nHeightCount > 1) {
        nSubsidy = 0.01 * COIN / nHeightCount;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in JXCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // JXCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JXCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        unsigned int nTimeGenesis = fTestNet ? 1497947544 : 1497958344;

        unsigned int nNonceGenesis = fTestNet ? 71988 : 3531510;

        const char* pszTimestamp = "JXC Genesis Block";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = nTimeGenesis + 2;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = nNonceGenesis;//!fTestNet ? 2698010 : 3520;
        ...
        //// debug print
       if(fTestNet){
         assert(block.hashMerkleRoot == uint256("0x14cf01e74f6b2cefbc525f11583c9a9afd1ae9b5bee58ccf4c22f4296d6e6e06"));
       }
       else {
         assert(block.hashMerkleRoot == uint256("0x20319812d41385f31d999b6eef35dcdd35c6613558802fd2e2244a63cf6bd470"));
       }
...
unsigned char pchMessageStart[4] = { 0xe2, 0xe9, 0xa9, 0xd9 };
